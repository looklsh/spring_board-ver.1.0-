...
public class BDao {
	...
	private void replyShape(String strGroup, String strStep) {
		...
		try {
			...
			int rn5 = preparedStatement.executeUpdate();
		} catch (Exception e) {
	...
	public void reply(String bId, String bName, String bTitle, String bContent, String bGroup, String bStep, String bIndent) {
		...
		try {
			...
			int rn4 = preparedStatement.executeUpdate();
		} catch (Exception e) {
			// TODO: handle exception
			e.printStackTrace();
		}finally {
	...
	public void delete(String strId) {
		...
		try {
			...
			int rn3 = preparedStatement.executeUpdate();
		} catch (Exception e) {
			// TODO: handle exception
			e.printStackTrace();
		}finally {
	...
	private void upHit(String bId) {
		...
		try {
			...
			int rn1 = preparedStatement.executeUpdate();
		} catch (Exception e) {
			// TODO: handle exception
			e.printStackTrace();
		}finally {
